...
Fixpoint binddt_term
  ...
  match t with
  | tvar v => f (0, v)
  | letin body => pure (lam τ) <⋆> binddt_term (preincr f 1) body
...
|*)
  ...
  #[export] Instance DTM_Lam:
    DecoratedTraversableMonad nat term :=
    {| kdtm_binddt0 := @dtm1_stlc;
    |}.

  #[export] Instance Map_Lam: Map term
    := Map_Binddt nat term term.
  #[export] Instance Mapd_Lam: Mapd nat term
    := Mapd_Binddt nat term term.
  #[export] Instance Traverse_Lam: Traverse term
    := Traverse_Binddt nat term term.
  #[export] Instance Mapdt_Lam: Mapdt nat term
    := Mapdt_Binddt nat term term.
  #[export] Instance Bind_Lam: Bind term term
    := Bind_Binddt nat term term.
  #[export] Instance Bindd_Lam: Bindd nat term term
    := Bindd_Binddt nat term term.
  #[export] Instance Bindt_Lam: Bindt term term
    := Bindt_Binddt nat term term.
  #[export] Instance Elements_Lam: Elements term
    := Elements_Traverse.

  #[export] Instance DTMFull_Lam:
